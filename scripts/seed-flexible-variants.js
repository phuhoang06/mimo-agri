// Script để thêm products với variant system linh hoạt
// Chạy: node scripts/seed-flexible-variants.js
...
async function seedFlexibleVariants() {
  console.log('🌱 Thêm products với variant system linh hoạt...')

  try {
    // Lấy category ID cho "Dụng Cụ Làm Vườn"
    ...
    if (!dungCuLamVuonId) {
      console.error('❌ Không tìm thấy category "Dụng Cụ Làm Vườn"')
      return
    }
    ...
    const gangTayProduct = {
      ...
      // Một số variant combinations mẫu
    ...
    console.log('🎉 Seed flexible variants thành công!')
    ...
    console.error('❌ Lỗi seed flexible variants:', error)
  }
}

// Chạy seed
seedFlexibleVariants()
